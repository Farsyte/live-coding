        ...
        ;;   adjusted for assembly with "ASL"
        ;;   - make us independent of DISKDEF.LIB
        ;;     making DISKDEF.LIB work with ASL is a challenge.
        ;;   - add CPU declaration
	;;   - set up JMP to allow "MVI A,JMP"
        ;;   - ASL does not allow "$" in the middle of numbers like 0111$1110b
        ;;   - shift to using ASL operators:
        ;;     - NOT becomes ~~
        ;;     - MOD becomes #
        ;;     - AND becomes & (in bitwise-AND contexts)
        ;;     - SHR becomes >>
...
;
;
test	equ	0	;1=test bios 0=normal bios
;
	if	test
