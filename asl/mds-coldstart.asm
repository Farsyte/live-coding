...
;
; modified slightly (October 2023) so "asm8080" can assemble it
; modified slightly (October 2023) so "ASL" can assemble it
;
;false	equ	0               ;ASL: "variables cannot be redefined as constants"
;true	equ	1               ;ASL: "variables cannot be redefined as constants"
...
;
	org	03000h		;loaded here by hardware
;
bdosl	equ	bdose-cpmb	;length of BDOS in bytes
