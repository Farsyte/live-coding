...
// HexStoreFp: ptr to callback function receiving data from a HEX file.
//
...
typedef void        (*HexStoreFp)(void *ctx, unsigned addr, unsigned data);
...
extern int          hex_parse(Cstr filename, HexStoreFp store, void *ctx);
